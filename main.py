...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    parser.add_argument("-l", "--license", type=str, help="SPDX license identifier to check for.")
    parser.add_argument(
        "filenames",
        type=str,
        nargs="*",
    ...
    filenames_str = ",".join(args.filenames)
    
    spdx_checker.spdx_license_checker(args.license, filenames_str)
